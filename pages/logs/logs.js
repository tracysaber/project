...
Page({
  data: {
    ...
    "二〇二〇年  二〇三五年#十九大 二十大",
    "创新#发展",
    "高速增长,高水平发展#高速增长,高质量发展",
    "优化经济结构#供给侧结构性改革",
    "实体经济#共享经济"],
    answers:['2','1','2','1','1','1','1','1','2','1','2','1','2','1','1','2','2','2','2','2','2','1'],
  },
  ...
  onLoad: function () {
    ...
    var s = new Set();
    while(s.size!=10){
      s.add(Math.floor(Math.random() * 22));
    }
    this.data.ten = Array.from(s);
